...
def start():
    ...
    player1_selected, name1 = select_player("请输入先落子玩家。按 <Ctrl-C> 结束\n"
                                            "1: 人类\n"
                                            "2: 纯蒙特卡洛树搜索的 AI\n"
                                            "3: 带有神经网络的蒙特卡洛树搜索 AI\n"
                                            "Please input first player. Press <Ctrl-C> to end\n"
                                            "1: Human\n"
    ...
    player2_selected, name2 = select_player("请输入后落子玩家。按 <Ctrl-C> 结束\n"
                                            "1: 人类\n"
                                            "2: 纯蒙特卡洛树搜索的 AI\n"
                                            "3: 带有神经网络的蒙特卡洛树搜索 AI\n"
                                            "Please input second player. Press <Ctrl-C> to end\n"
                                            "1: Human\n"
                                            "2: AI with pure Monte Carlo tree search\n"
                                            "3: AI with Monte Carlo tree search & neural network\n"
                                            ": ", allowed_input=[1, 2, 3])
